...
import com.kedar.moviecollection.util.MovieFormWrapper;
import com.kedar.moviecollection.util.TextForm;
...
public class AppController {
	...
	public ModelAndView getMovies(
		...
		// Determine the user's role and set the appropriate view
	    Authentication auth = SecurityContextHolder.getContext().getAuthentication();
	    boolean isAdmin = auth.getAuthorities().contains(new SimpleGrantedAuthority("ROLE_ADMIN"));
	    if (isAdmin) {
	        mav.setViewName("index"); // admin's view
	    } else {
	        mav.setViewName("userindex"); // user's view
	    }
